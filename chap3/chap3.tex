...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.1\textwidth,trim=410 0 0 0,clip=true]{chap3/Figures/dd2-nulum.eps}
\caption{
...
\begin{figure*}[!htbp]
\centering \includegraphics[width=1.1\textwidth,trim=410 0 0 0,clip=true]{chap3/Figures/eos_theta_hist_flux.pdf}
\caption{
