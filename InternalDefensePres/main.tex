...
% \item[] 
    ...
    \item[] \phantom{te}Prof. John Sipe (convener)
...
\begin{columns}
  \begin{column}{.48\textwidth}
    ...
    \begin{itemize}[label=\FilledSmallSquare]
      \scriptsize
    \item Currently no code can handle multi-scales/microphysics required for all realistic simulations (10cm for MRI, 1-2000km for GW).
    ...
    \begin{mybox}{white}{\centering \scriptsize Chapter 1}
     \scriptsize
      Develop a new code using new more powerful numerical techniques for problems in numerical realtivity.
    \end{mybox}
...
\frame{
  \frametitle{Chapter 1: Next generation Numerical Relativity}
...
\vspace{1cm}
  ...
  My task: develop elliptic solver for Einstein constraint equations. 
...
\frame{
  ...
  \begin{itemize}[label=\FilledSmallSquare]
    %% \scriptsize
    \item Main paper detailing scheme/results uploaded to arXiv this week
    \item port into the task based parallel SpECTRe code - currently being done at the Albert Einstein Institute by Nils Fischer.
...
\frame{
  \frametitle{Chapter 2: Unequal Mass BNS w/ Neutrino Transport}
...
\frame{
  \frametitle{Chapter 2: Unequal Mass BNS + Neutrino Transport}
...
\includegraphics[width=\textwidth]{./pictures/bns-runs.png}
    \end{column}
    \begin{column}{.48\textwidth}
      \includegraphics[width=\textwidth]{./pictures/chap3/Figures/eos.png}
    \end{column}
  \end{columns}
...
\frame{
  \frametitle{General Overview: 3ms}
    \vspace{-.15cm}
\includegraphics[width=.9\textwidth,trim=0 0 0  60,clip=true]{./pictures/chap3/Figures/{misc_tabular_3ms_2}.png}
}

\frame{
  \frametitle{General Overview: 7.5ms}
    \vspace{-.15cm}
\includegraphics[width=.9\textwidth,trim=0 0 0  60,clip=true]{./pictures/chap3/Figures/{misc_tabular_7.5ms_2}.png}
}
...
\frame{
  ...
  SFHo has the most ejecta \\
  Collapse runs produce no ejecta \\
  Ejecta is equatorial mostly
}
...
\frame{
  \frametitle{Velocity Distribution}
    ...
    \end{column}
    \begin{column}{.48\textwidth}
  \includegraphics[width=\textwidth]{./pictures/chap3/Figures/eos_sfho_vinf_equa.png}
  \includegraphics[width=\textwidth]{./pictures/chap3/Figures/eos_sfho_vinf_polar.png}
    \end{column}
    \end{columns}
...
\frame{
  \frametitle{$Y_e$ Distribution}
   ...
   \begin{columns}
    ...
    \end{column}
    \begin{column}{.48\textwidth}
  \includegraphics[width=\textwidth]{./pictures/chap3/Figures/eos_sfho_ye_equa.png}
  \includegraphics[width=\textwidth]{./pictures/chap3/Figures/eos_sfho_ye_polar.png}
    \end{column}
    \end{columns}
...
\frame{
  ...
  \centering Neutrinos deposit net lepton number into the ejecta
...
\frame{
  ...
  \begin{columns}
    \begin{column}{.48\textwidth}
\scriptsize
Largest concentration of neutrinos in polar regions, tail and disk.\\
...
\frame{
  ...
  \includegraphics[height=.5\textheight,width=\textwidth]{./pictures/d12132-neutrino-lum.png}
    ...
    \end{columns}
\vspace{.5cm}
    SFHo has largest luminosity \\
    No Dependence on mass-ratio
...
\frame{
  ...
  \begin{itemize}[label=\FilledSmallSquare]
      %% \scriptsize
    \item Collapse models no ejecta, small disk mass
  ...
  \begin{itemize}[label=\FilledSmallSquare]
    ...
    \item Continue collapse runs, Tracers
